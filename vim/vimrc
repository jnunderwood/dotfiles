...
if ! exists('g:vimified_packages')
    let g:vimified_packages = ['general', 'fancy', 'os', 'coding', 'python', 'ruby', 'go', 'html', 'css', 'js', 'clojure', 'haskell', 'color']
endif
" }}}
...
if count(g:vimified_packages, 'python')
    ...
    " Bundle 'vim-virtualenv'  no longer works - jnu
endif
" }}}
...
if count(g:vimified_packages, 'html')
    ...
    " Bundle 'tpope/vim-markdown'  " using different markdown plugin elsewhere
