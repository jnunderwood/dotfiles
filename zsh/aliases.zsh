...
alias      usercount='/usr/bin/docker exec -it $1.unch.unc.edu /bin/sh -c "/bin/grep Username /home/app/logs/* | /usr/bin/wc -l"'
alias           motd='/usr/bin/sudo update-motd | /bin/grep -v "No Module Installed"'  # '/bin/cat /var/run/motd'
