# Generated by Powerlevel10k configuration wizard on 2020-02-24 at 10:38 UTC.
...
# solid, no frame, dark-ornaments, sparse, many icons, fluent, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="$(box_name)"
